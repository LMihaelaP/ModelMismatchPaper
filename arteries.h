...
extern double   conv, rho, mu, mu_pl, nu, Lr, Lr2, Lr3, g, q, Fr2,
                ...
                Deltat, tau, *fjac[18], xr, f, df;

extern int nbrves;

extern int tmstps;

extern const char* CO_filename;
...
public:
  ...
  double K_loss;
  double ff1, ff2, ff3, m1;
  double Res1, Res2, CT,LT;
  ...
  Tube (double Length,
        ...
        double f1, double f2, double f3, double m1,
        double Res1_in, double Res2_in, double CT_in);
                                                         // Constructor.
  ~Tube ();                                              // Destructor.
...
//  void bound_right (int qLnb, double k, double theta, double t);
  void bound_right ( double k, double theta, double t);
